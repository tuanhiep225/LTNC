...
<head>
    ...
    <!--BEGIN CSS KENDO -->
    <link href="${pageContext.request.contextPath}/assets/KendoJs/styles/kendo.common.min.css" rel="stylesheet" />
    <link href="${pageContext.request.contextPath}/assets/KendoJs/styles/kendo.rtl.min.css" rel="stylesheet" />
    <link href="${pageContext.request.contextPath}/assets/KendoJs/styles/kendo.default.min.css" rel="stylesheet" />
    <link href="${pageContext.request.contextPath}/assets/KendoJs/styles/kendo.default.mobile.min.css" rel="stylesheet" />
    <!-- END CSS KENDO -->
    <script src="${pageContext.request.contextPath}/assets/KendoJs/js/jquery.min.js"></script>
    <script src="${pageContext.request.contextPath}/assets/KendoJs/js/kendo.all.min.js"></script>
                            ...
                            <li>
                                <ul class="dropdown-menu-list scroller" style="height: 275px;" data-handle-color="#637283">
                                    <li>
                                        <a href="#">
                                            <span class="photo">
                                                <img src="${pageContext.request.contextPath}/assets/layouts/layout3/img/avatar2.jpg" class="img-circle" alt="">
                                            </span>
                                            <span class="subject">
                                                <span class="from"> Lisa Wong </span>
                                                <span class="time">Just Now </span>
                                            </span>
                                            <span class="message"> Vivamus sed auctor nibh congue nibh. auctor nibh auctor nibh${pageContext.request.contextPath}. </span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#">
                                            <span class="photo">
                                                <img src="${pageContext.request.contextPath}/assets/layouts/layout3/img/avatar3.jpg" class="img-circle" alt="">
                                            </span>
                                            <span class="subject">
                                                <span class="from"> Richard Doe </span>
                                                <span class="time">16 mins </span>
                                            </span>
                                            <span class="message"> Vivamus sed congue nibh auctor nibh congue nibh. auctor nibh auctor nibh${pageContext.request.contextPath}. </span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#">
                                            <span class="photo">
                                                <img src="${pageContext.request.contextPath}/assets/layouts/layout3/img/avatar1.jpg" class="img-circle" alt="">
                                            </span>
                                            <span class="subject">
                                                <span class="from"> Bob Nilson </span>
                                                <span class="time">2 hrs </span>
                                            </span>
                                            <span class="message"> Vivamus sed nibh auctor nibh congue nibh. auctor nibh auctor nibh${pageContext.request.contextPath}. </span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#">
                                            ...
                                            <span class="message"> Vivamus sed auctor 40% nibh congue nibh${pageContext.request.contextPath}. </span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#">
                        ...
                        <div class="page-quick-sidebar-chat-users" data-rail-color="#ddd" data-wrapper-class="page-quick-sidebar-list">
                            ...
                            <ul class="media-list list-items">
                                <li class="media">
                                    ...
                                    <img class="media-object" src="${pageContext.request.contextPath}/assets/layouts/layout/img/avatar3.jpg" alt="${pageContext.request.contextPath}.">
                                ...
                                <li class="media">
                                    <img class="media-object" src="${pageContext.request.contextPath}/assets/layouts/layout/img/avatar1.jpg" alt="${pageContext.request.contextPath}.">
                                    <div class="media-body">
                                ...
                                <li class="media">
                                    ...
                                    <img class="media-object" src="${pageContext.request.contextPath}/assets/layouts/layout/img/avatar4.jpg" alt="${pageContext.request.contextPath}.">
                                    <div class="media-body">
                                ...
                                <li class="media">
                                    <img class="media-object" src="${pageContext.request.contextPath}/assets/layouts/layout/img/avatar2.jpg" alt="${pageContext.request.contextPath}.">
                                    <div class="media-body">
                            ...
                            <ul class="media-list list-items">
                                <li class="media">
                                    ...
                                    <img class="media-object" src="${pageContext.request.contextPath}/assets/layouts/layout/img/avatar6.jpg" alt="${pageContext.request.contextPath}.">
                                    <div class="media-body">
                                ...
                                <li class="media">
                                    ...
                                    <img class="media-object" src="${pageContext.request.contextPath}/assets/layouts/layout/img/avatar7.jpg" alt="${pageContext.request.contextPath}.">
                                    <div class="media-body">
                                ...
                                <li class="media">
                                    <img class="media-object" src="${pageContext.request.contextPath}/assets/layouts/layout/img/avatar8.jpg" alt="${pageContext.request.contextPath}.">
                                    <div class="media-body">
                                ...
                                <li class="media">
                                    ...
                                    <img class="media-object" src="${pageContext.request.contextPath}/assets/layouts/layout/img/avatar9.jpg" alt="${pageContext.request.contextPath}.">
                                    <div class="media-body">
                                ...
                                <li class="media">
                                    <img class="media-object" src="${pageContext.request.contextPath}/assets/layouts/layout/img/avatar10.jpg" alt="${pageContext.request.contextPath}.">
                                    <div class="media-body">
                                ...
                                <li class="media">
                                    ...
                                    <img class="media-object" src="${pageContext.request.contextPath}/assets/layouts/layout/img/avatar11.jpg" alt="${pageContext.request.contextPath}.">
                                    <div class="media-body">
                        ...
                        <div class="page-quick-sidebar-item">
                            <div class="page-quick-sidebar-chat-user">
                                ...
                                <div class="page-quick-sidebar-chat-user-messages">
                                    <div class="post out">
                                        <img class="avatar" alt="" src="${pageContext.request.contextPath}/assets/layouts/layout/img/avatar3.jpg" />
                                        <div class="message">
                                            <span class="arrow"></span>
                                    ...
                                    <div class="post in">
                                        <img class="avatar" alt="" src="${pageContext.request.contextPath}/assets/layouts/layout/img/avatar2.jpg" />
                                        <div class="message">
                                            <span class="arrow"></span>
                                ...
                                <div class="page-quick-sidebar-chat-user-form">
                                    <div class="input-group">
                                        <input type="text" class="form-control" placeholder="Type a message here${pageContext.request.contextPath}.">
