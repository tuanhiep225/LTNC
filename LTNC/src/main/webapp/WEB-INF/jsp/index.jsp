  ...
  <body class="nav-md">
    <div class="container body">
      <div class="main_container">
        ...
        <!-- /page content -->
			<%@include file="/WEB-INF/layout/_pagecontent.jsp" %>
        <!-- footer content -->
        <footer>
    ...
    <script src="${pageContext.request.contextPath}/resources/js/datepicker/daterangepicker.js"></script>
