...
<div class="clearfix"></div>
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Quản lý màu sắc<small>Sửa</small></h2>
                  ...
                  <div class="x_content">
                    <br />
                    <form:form id="demo-form2" class="form-horizontal form-label-left" action="/LTNC/product-color/update" method="POST" commandName="productColor">
						<form:input path="productColorId" type="hidden"/>
